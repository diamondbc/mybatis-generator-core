...
public class ServicePlugin extends PluginAdapter {
	...
	public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
		...
		// 取Service名称【com.XX.service.IUserService】
		...
		// 【com.XX.service.impl.UserService】logger.info(toLowerCase(daoType.getShortName()));
	...
	protected void addServiceImpl(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, String tableName,
		...
		if (enableUpdateByPrimaryKeySelective) {
			topLevelClass
					.addMethod(getOtherInteger("updateByPrimaryKeySelective", introspectedTable, tableName, 1, false));
		}
		...
		if (enableUpdateByExampleSelective) {
			topLevelClass
					.addMethod(getOtherInteger("updateByExampleSelective", introspectedTable, tableName, 4, false));
		}
